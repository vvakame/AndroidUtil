...
// fork from original ListFragment.
 ...
 * hierarchy <em>must</em> contain a ListView object with the id
 ...
 * ListFragment.setListAdapter()} to associate the list with an adapter. Do not
 * directly call {@link ListView#setAdapter(ListAdapter) ListView.setAdapter()}
...
public class CustomListFragment extends Fragment {
	...
	private void ensureList() {
		...
		if (root instanceof ListView) {
			...
			mProgressContainer = root.findViewById(android.R.id.progress);
